...
/*
        ...
        PhoneNumber q = new PhoneNumber();
        q .num = 8421;
        q .numType = " Личный hw42";
        PhoneNumber w = new PhoneNumber(" Личный hw42", 8422);
        System.out.println(q.num + q.numType);
        System.out.println(w.num + w.numType);
    }
}
*/